...
public class Constants {
    ...
    public final static String FILE_UPLOAD_DIC = "/Users/bin_mac/Downloads/mall/src/main/resources/upload/upload/";//上传文件的默认url前缀，根据部署设置自行修改
